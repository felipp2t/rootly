...
export abstract class WorkspaceRoleRepository {
  ...
  abstract findByWorkspaceId(workspaceId: string): Promise<WorkspaceRole[]>
  abstract findByWorkspaceIdAndName(workspaceId: string, name: string): Promise<WorkspaceRole | null>
